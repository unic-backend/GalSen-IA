...
Phases           : 27
Phase courante   : **L07.1 — en attente de confirmation** (locuteurs et langues,
                   §9, §10, §11)
Terminées        : L00 à L06 — quatre audits, ADR-033, et `src/live_context/` :
                   `state.py`, `capture.py`, `fusion.py` (103 tests)
