...
Phase 3.1 a fermé une fuite mesurée : quatre routes recopiaient le texte de
l'exception dans le 500 (hôte interne, chemin de fichier). `erreur_interne()`
journalise la cause avec sa pile et rend un identifiant d'incident.
