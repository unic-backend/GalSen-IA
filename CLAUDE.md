...
unattended), **142 API routes**, 35 ADRs (ADR-020 is `proposed`; ADR-024 to ADR-027 open the creative programme;
...
ADR-033 opens the live-context layer; **ADR-034 audits OpenClaw and does not integrate it**) — see
