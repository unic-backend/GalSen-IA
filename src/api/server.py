...
# Services backend (VOLET 02, Phase 3 — Intégrations externes)
...
# Monter le dashboard d'administration sur /admin
try:
    from src.frontend import create_dashboard_app
    dashboard_app = create_dashboard_app()
    app.mount("/admin", dashboard_app)
except ImportError:
    print("Dashboard non disponible (frontend optionnel)")
