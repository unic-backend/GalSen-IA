"""
Tests d'intégration pour l'auth hybride (JWT + API Key).

Couvre : endpoints /auth/login, /auth/register, /auth/refresh, /auth/me,
fallback JWT → API Key, require_auth_jwt, et accès aux endpoints protégés.
"""
